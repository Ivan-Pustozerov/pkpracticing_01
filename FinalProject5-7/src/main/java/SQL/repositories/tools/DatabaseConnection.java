...
public class DatabaseConnection{
    ...
    private static final ThreadLocal<String> url = ThreadLocal.withInitial(() -> "jdbc:postgresql://localhost:5432/Final");
    private static final ThreadLocal<String> user = ThreadLocal.withInitial(() -> "postgres");
    private static final ThreadLocal<String> password = ThreadLocal.withInitial(() -> "lkroot");
