...
class LinkedListTabulatedFunctionTest {
    ...
    void testConstructorWithMismatchedArrays() {
        double[] xsBad = {1, 2, 3};
        double[] ysBad = {10, 20};
        assertThrows(DifferentLengthOfArraysException.class, () -> new LinkedListTabulatedFunction(xsBad, ysBad));
    }
    @Test
    void testConstructorWithUnsortedArrays() {
        double[] xsBad = {2, 3, 1};
        double[] ysBad = {10,10, 20};
        assertThrows(ArrayIsNotSortedException.class, () -> new LinkedListTabulatedFunction(xsBad, ysBad));
    }
